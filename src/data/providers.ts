...
export const PROVIDERS: ProviderInfo[] = [
  ...
  {
    id: "qwen", name: "Qwen Cloud · DashScope", kind: "cloud",
    baseUrl: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1",
    keyName: "DASHSCOPE_API_KEY", keyUrl: "https://dashscope-intl.console.aliyun.com/apiKey",
    docs: "https://www.alibabacloud.com/help/en/model-studio",
    note: "1M free tokens · Qwen3-Max, Qwen3-Coder.",
    accent: "#6f5cff",
  },
  {
    ...
    note: "$25 free credits monthly · Grok 4.",
    accent: "#dfe3ea",
  },
  {
    ...
    note: "Free trial credits · V3-Chat, R1.",
    accent: "#6f8bff",
  },
  {
    ...
    note: "Free Experiment plan · Codestral.",
    accent: "#ff7000",
  },
  {
    ...
    note: "Free trial key · Command A.",
    accent: "#f45da0",
  },
  {
    id: "zai", name: "Z.AI · Zhipu", kind: "cloud",
    baseUrl: "https://api.z.ai/api/paas/v4",
    keyName: "ZAI_API_KEY", keyUrl: "https://z.ai/manage-apikey/apikey-list", docs: "https://docs.z.ai",
    note: "GLM-4.5-Flash is free · GLM family.",
    accent: "#4f7dff",
  },
  {
    id: "nvidia", name: "NVIDIA NIM", kind: "inference",
    baseUrl: "https://integrate.api.nvidia.com/v1",
    keyName: "NVIDIA_API_KEY", keyUrl: "https://build.nvidia.com", docs: "https://docs.nvidia.com/nim",
    note: "1000 free credits · Llama, Nemotron.",
    accent: "#76b900",
  },
  {
    id: "siliconflow", name: "SiliconFlow", kind: "inference",
    baseUrl: "https://api.siliconflow.cn/v1",
    keyName: "SILICONFLOW_API_KEY", keyUrl: "https://cloud.siliconflow.cn/account/ak", docs: "https://docs.siliconflow.cn",
    note: "Generous free quota · open models.",
    accent: "#5b8cff",
  },
  {
