...
export const PROVIDERS: ProviderInfo[] = [
  ...
  {
    id: "qwen", name: "Qwen Cloud", kind: "cloud",
    baseUrl: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1",
    keyName: "DASHSCOPE_API_KEY", keyUrl: "https://bailian.console.aliyun.com", docs: "https://www.alibabacloud.com/help/en/model-studio",
    note: "通义千问 Qwen · international endpoint, free quota, OpenAI-compatible.",
    accent: "#8b7cff",
  },
  {
  ...
  },
  {
    ...
    note: "Grok free tier for new accounts.",
    accent: "#e8e8e8",
  },
  {
  ...
  },
  {
    ...
    note: "Free trial key for Command models.",
    accent: "#f45da0",
  },
  {
    ...
    note: "Free quota for new accounts.",
    accent: "#6f8bff",
  },
  {
    id: "zai", name: "Z.AI (GLM)", kind: "cloud",
    baseUrl: "https://api.z.ai/api/paas/v4",
    keyName: "ZAI_API_KEY", keyUrl: "https://z.ai", docs: "https://docs.z.ai",
    note: "GLM models, free credits.",
    accent: "#35b89f",
  },
  {
    id: "nvidia", name: "NVIDIA NIM", kind: "inference",
    baseUrl: "https://integrate.api.nvidia.com/v1",
    keyName: "NVIDIA_API_KEY", keyUrl: "https://build.nvidia.com", docs: "https://build.nvidia.com",
    note: "1,000 free inference credits.",
    accent: "#76b900",
  },
  {
    id: "siliconflow", name: "SiliconFlow", kind: "inference",
    baseUrl: "https://api.siliconflow.com/v1",
    keyName: "SILICONFLOW_API_KEY", keyUrl: "https://cloud.siliconflow.cn", docs: "https://docs.siliconflow.cn",
    note: "Free quota + many free open models.",
    accent: "#5b8cff",
  },
  {
