...
function CodeBlock({ lang, code }: { lang: string; code: string }) {
  ...
  return (
    <pre>
      <span className="flex items-center justify-between border-b border-line bg-ink px-3.5 py-1.5">
        ...
        <button
          ...
          className="font-mono text-[11px] text-dim transition-colors hover:text-violet2"
        >
          {copied ? "✓" : "copy"}
        </button>
      </span>
